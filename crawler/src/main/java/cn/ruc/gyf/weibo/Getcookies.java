...
public class Getcookies {
	public String getCookie(String userName, String passWord)
		...
		// webClient.addRequestHeader("User-Agent", "Mozilla/5.0 (Linux; Android
		// 4.4.2; Nexus 4 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko)
		// Chrome/35.0.1916.122 Mobile Safari/537.36");
